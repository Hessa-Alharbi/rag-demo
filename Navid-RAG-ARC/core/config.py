...
class Settings(BaseSettings):
    ...
    HF_TOKEN: Optional[str] = None  # Added HuggingFace token
    ...
    MILVUS_AUTO_ID: bool = True  # Added auto_id setting
    MILVUS_DIMENSION: int = 384  # Added dimension setting for model
